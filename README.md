...
**The Tech Paradox:** Contrary to the "Digital Sedentary" myth, Technology Use (`TUE`) is negatively correlated with obesity ($r=-0.30$) in this dataset. The highest risk group is the "Non-Digital Sedentary" demographic (No Tech + No Exercise).
...
*   **The "Vegetable Anomaly":** Severe obesity (Type III) is associated with the *highest* reported vegetable consumption, suggesting reverse causality (dieting due to condition) or reporting bias.
*   **Optimal Habits:** The standard "3 meals + moderate water" routine is statistically linked to higher obesity. The optimal pattern identified is **High Hydration (>2L) + Frequent Meals (NCP=4)**.
*   **Patient Clusters:** K-Means identified 4 distinct profiles:
    *   *Cluster 0:* The Veggie-Lovers (Sedentary but eat healthy).
    *   *Cluster 1:* The Active Tech-Users (Gamers/Students).
    *   *Cluster 2:* The Meal Skippers (Metabolic risk).
    *   *Cluster 3:* The Older Generation.
*   **Modeling:** Treating Obesity as an **Ordinal Classification** problem (MAE $\approx$ 0.35) prevents dangerous errors (e.g., confusing Type III with Normal) better than standard classifiers.
